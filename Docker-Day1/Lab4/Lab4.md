```bash
amir@amir-ubuntu:~$ docker run -dit --name apache httpd
844474f856999eeca4ab19dad33cec6a05a5b8553a6b862c5da5d45d0678bfef
amir@amir-ubuntu:~$ ls /home/amir/Desktop/StaticWebSite/
index.html
amir@amir-ubuntu:~$ docker cp /home/amir/Desktop/StaticWebSite/index.html apache:/usr/local/apache2/htdocs/index.html
Successfully copied 2.56kB to apache:/usr/local/apache2/htdocs/index.html
amir@amir-ubuntu:~$ curl http://localhost:8080
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
```bash
amir@amir-ubuntu:~$ docker commit apache my-apache
...
amir@amir-ubuntu:~$ docker images
